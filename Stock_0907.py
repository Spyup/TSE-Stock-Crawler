        ...
        while True:
            ...
            if now < STOP_TIME:
                if times == 1:
                    ...
                    data = crawling.show_realtime(*stock_ids_5)
                elif times == 6:
                    data = crawling.show_realtime(*stock_ids_6)
                elif times == 7:
                    data = crawling.show_realtime(*stock_ids_7)
                elif times == 8:
                    data = crawling.show_realtime(*stock_ids_8)
                elif times == 9:
                    data = crawling.show_realtime(*stock_ids_9)
